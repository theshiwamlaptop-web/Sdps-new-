...
start_str = '        var eReceipt by remember { mutableStateOf(original.receiptNo.ifBlank { "REC-${System.currentTimeMillis()}" }) }'
end_str = '    }//if (selectedEntryForReceipt != null) {'
...
'''
    ...
    with open('app/src/main/java/com/example/ui/screens/SchoolAppScreens.kt', 'w') as f:
        f.write(content)
    print("Replaced successfully via find!")
else:
    print("Block not found via find!")
